...
namespace Api_Karate_Pro.model.proc
{
    ...
    {
        public static Respuesta grabaPelea(pelea_G_pelea pelea)
        {
            ...
            try
            {
                ...
                vector[0] = "@pel_hora,f," + pelea.pel_hora;
                ...
                vector[6] = "@tec_puntos,i," + pelea.tec_puntos;
        ...
        public static Respuesta eliminaPelea(pelea_E_pelea pelea)
        {
        ...
        public static Respuesta actualizaPelea(pelea_A_pelea pelea)
        {
            ...
            try
            {
                ...
                vector[0] = "@pel_hora,f," + pelea.pel_id;
                vector[1] = "@pel_id,i," + pelea.pel_id;
                vector[2] = "@com_id,i," + pelea.pel_id;
                ...
                vector[7] = "@tec_puntos,i," + pelea.tec_puntos;
