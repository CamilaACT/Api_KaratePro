    ...
    public class p_Competencia
    {
        public static Respuesta actualizaCompetencia(competencia_A_competencia competencia)
        {
            ...
            try
            {
                ...
                vector[2] = "@com_fecha,f," + competencia.com_fecha;
        ...
        public static Respuesta eliminaCompetencia(competencia_E_competencia competencia)
        {
        ...
        public static Respuesta grabaCompetencia(competencia_G_competencia competencia)
        {
            ...
            try
            {
                ...
                vector[1] = "@com_fecha,f," + competencia.com_fecha;
